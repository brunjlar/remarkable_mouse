...
def main():
    try:
        ...
        parser.add_argument('--address', default='192.168.2.104', type=str, help="device address")
        parser.add_argument('--mode', default='fill', choices=['fit', 'fill'], help="scale setting")
        parser.add_argument('--orientation', default='bottom', choices=['top', 'left', 'right', 'bottom'], help="position of tablet buttons")
